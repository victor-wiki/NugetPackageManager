...
namespace NugetPackageManager
{
    ...
    {
        public static void ExecuteCommand(string filePath, string command, DataReceivedEventHandler outputEventHandler = null, DataReceivedEventHandler errorEventHandler = null, bool waitForInput = false)
        {
